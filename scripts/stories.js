class Storyline {
  ...
  init() {
    ...
    this.sliderPrevNav = document.querySelector(".story-prev-nav");
    this.sliderNextNav = document.querySelector(".story-next-nav");
  ...
  createControls() {
    ...
    this.sliderPrevNav.addEventListener("click", this.prevHandler);
    ...
    this.sliderNextNav.addEventListener("click", this.nextHandler);
  ...
  slidePrev() {
    ...
    if (this.currentSlide === 0) {
      this.prev.setAttribute("disabled", "true");
      this.sliderPrevNav.classList.add("disabled");
    }
    if (this.currentSlide !== this.slides.length) {
      this.next.removeAttribute("disabled");
      this.sliderNextNav.classList.remove("disabled");
      this.changeSlide(this.currentSlide);
    }
  }
  ...
  slideNext() {
    ...
    if (this.currentSlide === this.slides.length - 1) {
      ...
      this.sliderNextNav.classList.add("disabled");
    }
    if (this.currentSlide > 0) {
      this.prev.removeAttribute("disabled");
      this.sliderPrevNav.classList.remove("disabled");
      this.changeSlide(this.currentSlide);
    }
  }
}
